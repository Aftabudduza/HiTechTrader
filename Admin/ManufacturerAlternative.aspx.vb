...
Partial Class Admin_ManufacturerAlternative
    ...
    '        sQuery = "select DISTINCT A.ManufacturerName FROM (SELECT m.[Name] ManufacturerName, ma.Alternative FROM ManufacturerAlternative ma, Manufacturer m WHERE ma.ManufacturerId = m.Id AND ma.Alternative LIKE '%" & searchText & "%') A GROUP BY A.ManufacturerName ORDER BY A.ManufacturerName ASC "
