...
Partial Class Admin_NoWatermarkImages
            ...
            If str.Length > 0 Then
                ...
                If Not ds Is Nothing Then
                    If ds.Tables(0).Rows.Count > 0 Then
                        If Not ds.Tables(0).Rows(0)("Watermarkimg") Is Nothing And ds.Tables(0).Rows(0)("Watermarkimg").ToString() <> String.Empty Then
                        ...
                        End If
                    Else
                        DisplayAlert("You Haven't Upload No Water Mark Image yet!!!!!")
                    End If
                Else
                    DisplayAlert("You Haven't Upload No Water Mark Image yet!!!!!")
                End If
