...
#Region " Constructors "
    ...
    Public Sub New()
        ...
        ColInfo.Add(New ColumnInfo("Name", "String", 100, True, True))
        ColInfo.Add(New ColumnInfo("Company", "String", 100, True, True))
        ColInfo.Add(New ColumnInfo("Email", "String", 100, True, True))
        ColInfo.Add(New ColumnInfo("Address", "String", 400, True, True))
        ColInfo.Add(New ColumnInfo("Address1", "String", 400, True, True))
        ColInfo.Add(New ColumnInfo("City", "String", 100, True, True))
        ColInfo.Add(New ColumnInfo("State", "String", 30, True, True))
        ColInfo.Add(New ColumnInfo("Zip", "String", 30, True, True))
        ...
        ColInfo.Add(New ColumnInfo("Message", "String", 2147483647, True, True))
        ColInfo.Add(New ColumnInfo("ItemToPurchase", "String", 2147483647, True, True))
        ColInfo.Add(New ColumnInfo("ItemsToSale", "String", 2147483647, True, True))
        ...
        ColInfo.Add(New ColumnInfo("Type", "String", 100, True, True))
        ColInfo.Add(New ColumnInfo("OptionPrice", "String", 20, True, True))
        ColInfo.Add(New ColumnInfo("Price", "Double", 15, True, True))
        ColInfo.Add(New ColumnInfo("CardType", "String", 100, True, True))
        ColInfo.Add(New ColumnInfo("PONumber", "String", 100, True, True))
