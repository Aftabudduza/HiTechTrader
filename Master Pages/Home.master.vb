...
Partial Class Master_Pages_Home
    ...
    '            If ProductCategoryId > 0 Then
    '                html += "<li><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=0' title='Inventory List: All Categories'><span>Categories</span></a></li>"
    '                For Each dr As DataRow In ds.Tables(0).Rows
    '                    If Not dr("Id") Is Nothing And dr("Id").ToString() <> String.Empty Then
    '                        If CInt(dr("Id").ToString()) = ProductCategoryId Then
    '                            html += " <li class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr("Id").ToString()) & "'><span>" & dr("CategoryName") & "</span></a>"
    ...
    '                                                    html += "<li class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:block;'>"
    '                                                Else
    ...
    '                                                            html += " <li class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr3("Id").ToString()) & "'><span>" & dr3("CategoryName") & "</span></a></li>"
    '                                                        Else
    '                                                            html += " <li class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr3("Id").ToString()) & "'><span>" & dr3("CategoryName") & "</span></a></li>"
    '                                                        End If
    '                                                    End If
    '                                                Next
    '                                                html += "</ul></li>"
    '                                            Else
    '                                                If CInt(dr2("Id").ToString()) = ProductCategoryId Then
    '                                                    html += " <li class='active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a></li>"
    '                                                Else
    ...
    '                                        html += " <li class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr("Id").ToString()) & "'><span>" & dr("CategoryName") & "</span></a><ul style='display:block;'>"
    '                                    Else
    '                                        html += " <li class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr("Id").ToString()) & "'><span>" & dr("CategoryName") & "</span></a><ul style='display:none;'>"
    '                                    End If
    '                                    For Each dr2 As DataRow In dsChild.Tables(0).Rows
    '                                        If Not dr2("Id") Is Nothing And CInt(dr2("Id").ToString()) > 0 Then
    '                                            strChild2SQL = "SELECT * FROM Category c WHERE c.CategoryParentId =" & CInt(dr2("Id").ToString())
    ...
    '                                                    html += "<li class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:block;'>"
    '                                                Else
    '                                                    html += "<li class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:none;'>"
    '                                                End If
    '                                                For Each dr3 As DataRow In dsChild2.Tables(0).Rows
    '                                                    If Not dr3("Id") Is Nothing And CInt(dr3("Id").ToString()) > 0 Then
    '                                                        If CInt(dr3("Id").ToString()) = ProductCategoryId Then
    ...
    '                                    dsChild2 = BRIClassLibrary.SQLData.generic_select(strChild2SQL, strConnection)
    '                                    If Not dsChild2 Is Nothing And dsChild2.Tables(0).Rows.Count > 0 Then
    '                                        html += "<li class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul>"
    '                                        For Each dr3 As DataRow In dsChild2.Tables(0).Rows
    '                                            If Not dr3("Id") Is Nothing And CInt(dr3("Id").ToString()) > 0 Then
                                    ...
                                    If Not dsChild Is Nothing And dsChild.Tables(0).Rows.Count > 0 Then
                                        ...
                                        For Each dr2 As DataRow In dsChild.Tables(0).Rows
                                            If Not dr2("Id") Is Nothing And CInt(dr2("Id").ToString()) > 0 Then
                                                ...
                                                If Not dsChild2 Is Nothing And dsChild2.Tables(0).Rows.Count > 0 Then
                                                    If CInt(dr2("Id").ToString()) = ProductCategoryId Then
                                                        html += "<li id='subcat-" & dr2("Id").ToString() & "' class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:block;'>"
                                                    Else
                                                        html += "<li id='subcat-" & dr2("Id").ToString() & "' class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:block;'>"
                                                    End If
                                                    For Each dr3 As DataRow In dsChild2.Tables(0).Rows
                                                        If Not dr3("Id") Is Nothing And CInt(dr3("Id").ToString()) > 0 Then
                                                            If CInt(dr3("Id").ToString()) = ProductCategoryId Then
                                                                html += " <li id='subcat-" & dr3("Id").ToString() & "' class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr3("Id").ToString()) & "'><span>" & dr3("CategoryName") & "</span></a></li>"
                                                            Else
                                                                html += " <li id='subcat-" & dr3("Id").ToString() & "' class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr3("Id").ToString()) & "'><span>" & dr3("CategoryName") & "</span></a></li>"
                                                            End If
                                                        End If
                                                    Next
                                                    html += "</ul></li>"
                                                Else
                                                    If CInt(dr2("Id").ToString()) = ProductCategoryId Then
                                                        html += " <li id='subcat-" & dr2("Id").ToString() & "' class='active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a></li>"
                                                    Else
                                                        html += " <li id='subcat-" & dr2("Id").ToString() & "'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a></li>"
                                                    End If
                                                End If
                                            End If
                                        Next
                                            ...
                                            If Not dr2("Id") Is Nothing And CInt(dr2("Id").ToString()) > 0 Then
                                                ...
                                                If Not dsChild2 Is Nothing And dsChild2.Tables(0).Rows.Count > 0 Then
                                                    If CInt(dr2("Id").ToString()) = ProductCategoryId Or CInt(dr2("Id").ToString()) = nGPId Or CInt(dr2("Id").ToString()) = nPId Or CInt(dr2("Id").ToString()) = nId Then
                                                        html += "<li id='subcat-" & dr2("Id").ToString() & "' class='has-sub active'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:block;'>"
                                                    Else
                                                        html += "<li id='subcat-" & dr2("Id").ToString() & "' class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul style='display:none;'>"
                                                    End If
                                                    For Each dr3 As DataRow In dsChild2.Tables(0).Rows
                                                        If Not dr3("Id") Is Nothing And CInt(dr3("Id").ToString()) > 0 Then
                                                            If CInt(dr3("Id").ToString()) = ProductCategoryId Then
                            ...
                            If Not dsChild Is Nothing And dsChild.Tables(0).Rows.Count > 0 Then
                                ...
                                For Each dr2 As DataRow In dsChild.Tables(0).Rows
                                    If CInt(dr2("Id").ToString()) > 0 Then
                                        ...
                                        dsChild2 = BRIClassLibrary.SQLData.generic_select(strChild2SQL, strConnection)
                                        If Not dsChild2 Is Nothing And dsChild2.Tables(0).Rows.Count > 0 Then
                                            html += "<li id='subcat-" & dr2("Id").ToString() & "' class='has-sub'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr2("Id").ToString()) & "'><span>" & dr2("CategoryName") & "</span></a><ul>"
                                            For Each dr3 As DataRow In dsChild2.Tables(0).Rows
                                                If Not dr3("Id") Is Nothing And CInt(dr3("Id").ToString()) > 0 Then
                                                    html += " <li id='subcat-" & dr3("Id").ToString() & "'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & CInt(dr3("Id").ToString()) & "'><span>" & dr3("CategoryName") & "</span></a></li>"
                                                End If
                                            Next
                                            html += "</ul></li>"
                                        Else
