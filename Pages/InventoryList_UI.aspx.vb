...
Partial Class Pages_InventoryList_UI
            ...
            If Not ds Is Nothing And ds.Tables(0).Rows.Count > 0 Then
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For Each dr As DataRow In ds.Tables(0).Rows
                        ...
                        Else
                            If j > m Then
                                tbl.Append("<td></td><td class='ListCategoryColumn'><div><h3 class='MainCategory'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & dr("Id").ToString() & "' class='h3a'>" & dr("NAME").ToString() & "&nbsp;&nbsp;" & "(" & dr("total") & ")" & "</a></h3><ul class='ListCategory'>")
                                j = 0
                            Else
                                tbl.Append("<div><h3 class='MainCategory'><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & dr("Id").ToString() & "' class='h3a'>" & dr("NAME") & "&nbsp;&nbsp;" & "(" & dr("total") & ")" & "</a></h3><ul class='ListCategory'>")
                            End If
                        End If
                                        ...
                                        If Not dr2("Id") Is Nothing And dr2("Id").ToString() <> String.Empty Then
                                            If CInt(dr2("Id").ToString()) > 0 Then
                                                ...
                                                If Not ds3 Is Nothing And ds3.Tables(0).Rows.Count > 0 Then
                                                    tbl.Append("<li><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & dr2("Id").ToString() & "'>" & dr2("NAME") & "(" & dr2("Total") & ")" & "</a><ul class='ListCategory'>")
                                                    For Each dr3 As DataRow In ds3.Tables(0).Rows
                                                        If Not dr3("Id") Is Nothing And dr3("Id").ToString() <> String.Empty Then
                                                            If CInt(dr3("Id").ToString()) > 0 Then
                                                                tbl.Append("<li><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & dr3("Id").ToString() & "'>" & dr3("NAME") & "(" & dr3("Total") & ")" & "</a></li>")
                                                            End If
                                                        End If
                                                    Next
                                                    tbl.Append("</ul></li>")
                                                Else
                                                    tbl.Append("<li><a href='../Pages/ProductListing.aspx?sc_state=0&sc_page=0&sc_cat=" & dr2("Id").ToString() & "'>" & dr2("NAME") & "(" & dr2("Total") & ")" & "</a></li>")
                                                End If
                                            End If
                                        End If
                                    Next
