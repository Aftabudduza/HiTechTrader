            ...
            Try
                ...
                If Not ds Is Nothing Then
                    If ds.Tables(0).Rows.Count > 0 Then
                        html = "<img width='720' src='../ProductImages/Large/Images/" & ds.Tables(0).Rows(0)("ImageFileName") & "' alt='" & ds.Tables(0).Rows(0)("ImageFileName") & "' Height='auto' class='GalleryImage' id='GalMainImg' style='float: left;max-width: 720px;max-height: 600px;padding: 20px;'>"
                    End If
                End If
                ...
                If Not ds2 Is Nothing Then
                    If ds2.Tables(0).Rows.Count > 0 Then
                        sb += "<li><a href='../ProductImages/Large/Images/" & ds.Tables(0).Rows(0)("ImageFileName") & "'><img src='../ProductImages/Large/Images/" & ds.Tables(0).Rows(0)("ImageFileName") & "' alt='" & ds.Tables(0).Rows(0)("ImageFileName") & "' Height='auto' class='thumbnailImage' id='GalMainImg' style='float: left;padding: 13px;'></a></li>"
                        For Each dr As DataRow In ds2.Tables(0).Rows
                            If Not dr("ImageUrl") Is Nothing And dr("ImageUrl").ToString() <> String.Empty Then
                                ...
                                If filename.Contains(".jpg") Or filename.Contains(".jpeg") Or filename.Contains(".gif") Or filename.Contains(".png") Or filename.Contains(".bmp") Then
                                    sb += "<li><a href='../ProductImages/Large/Images/" & filename & "'><img src='../ProductImages/Large/Images/" & filename & "' alt='" & filename & "' Height='auto' class='thumbnailImage' id='GalMainImg' style='float: left;padding: 13px;'></a></li>"
                                End If
